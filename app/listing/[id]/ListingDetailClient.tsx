...
export default function ListingDetailClient({ params }: { params: { id: string } }) {
  ...
  const isSaved = savedAds.includes(params.id)
  const isLiked = likedAds.includes(params.id)
        ...
        <div className="flex gap-2 mb-4">
          <button
            ...
            className={`flex-1 py-3 rounded-xl font-semibold text-sm ${
              activeTab === 'details' ? 'bg-purple-600 text-white' : 'bg-white border border-gray-200 text-gray-700'
            }`}
          >
            Details
          </button>
          <button
            ...
            className={`flex-1 py-3 rounded-xl font-semibold text-sm ${
              activeTab === 'specs' ? 'bg-purple-600 text-white' : 'bg-white border border-gray-200 text-gray-700'
            }`}
          >
            Specifications
          </button>
